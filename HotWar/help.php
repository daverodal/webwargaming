...
<div id="gameRules">
    ...
    Red is for Rebel. <div class="unit rebel" alt="0" src="http://localhost/Couchigniter/js/short-red-arrow-md.png" style="border-color: rgb(204, 204, 204) rgb(102, 102, 102) rgb(102, 102, 102) rgb(204, 204, 204);   position: relative;"><section></section>
        <img src="http://localhost/Couchigniter/js/multiArmor.png" class="counter">
        <div>6 - 8</div>
    </div>
    <p></p>
    Blue if for Loyalist.
    <div class="unit loyalist" alt="0" src="http://localhost/Couchigniter/js/short-red-arrow-md.png" style="border-color: rgb(204, 204, 204) rgb(102, 102, 102) rgb(102, 102, 102) rgb(204, 204, 204); position: relative;"><section></section>
        <img class="arrow" src="http://localhost/Couchigniter/js/short-red-arrow-md.png" style="opacity: 0;">
        <img src="http://localhost/Couchigniter/js/multiMech.png" class="counter">
    ...
    This is Armor (tanks).
    <div class="unit rebel" alt="0" src="http://localhost/Couchigniter/js/short-red-arrow-md.png" style="border-color: rgb(204, 204, 204) rgb(102, 102, 102) rgb(102, 102, 102) rgb(204, 204, 204);  position: relative;"><section></section>
        <img src="http://localhost/Couchigniter/js/multiArmor.png" class="counter">
        <div>6 - 8</div>
    </div>
    ...
    <div class="unit rebel" alt="0" src="http://localhost/Couchigniter/js/short-red-arrow-md.png" style="border-color: rgb(204, 204, 204) rgb(102, 102, 102) rgb(102, 102, 102) rgb(204, 204, 204); position: relative;"><section></section>
        <img src="http://localhost/Couchigniter/js/multiInf.png" class="counter">
        <div>2 - 8</div>
    </div>
    <p></p>
    ...
    <div class="clear"></div>
    <div class="unit rebel" alt="0" src="http://localhost/Couchigniter/js/short-red-arrow-md.png" style="border-color: rgb(204, 204, 204) rgb(102, 102, 102) rgb(102, 102, 102) rgb(204, 204, 204); float:left;  position: relative;"><section></section>
        <img src="http://localhost/Couchigniter/js/multiArmor.png" class="counter">
        <div><span class="reduced">3 - 8</span></div>
    </div>
    <div class="unit loyalist" alt="0" src="http://localhost/Couchigniter/js/short-red-arrow-md.png" style="border-color: rgb(204, 204, 204) rgb(102, 102, 102) rgb(102, 102, 102) rgb(204, 204, 204); float:left; position: relative;"><section></section>
        <img class="arrow" src="http://localhost/Couchigniter/js/short-red-arrow-md.png" style="opacity: 0;">
        <img src="http://localhost/Couchigniter/js/multiMech.png" class="counter">
