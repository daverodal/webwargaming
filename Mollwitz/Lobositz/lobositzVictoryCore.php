...
class lobositzVictoryCore extends victoryCore
{
    ...
    protected function checkVictory($attackingId,$battle){
        ...
        if(!$this->gameOver){
            ...
            if(($this->victoryPoints[ANGLO_FORCE] > 60) && ($this->victoryPoints[ANGLO_FORCE] - ($this->victoryPoints[FRENCH_FORCE]) > 10)){
                $angloWin = true;
            }
            if(($this->victoryPoints[FRENCH_FORCE] > 60) && ($this->victoryPoints[FRENCH_FORCE] - $this->victoryPoints[ANGLO_FORCE] > 10)){
                $frenchWin = true;
            }
