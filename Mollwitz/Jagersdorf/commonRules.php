...
<h2>Common Rules</h2>
<p> These are the common rules for the Fredrick the Great Game System. These rules also will include the exclusive rules,
    for this particular game, Gross Jagersdorf. Exclusive rule also available for "at a glance" difference between this ang other games.</p>
...
<ul>
    ...
    <li>Regardless of movement points required, a unit may always move at least one hex per turn,
        provided they are not moving directly from one zoc to another.</li>
</ul>
...
<ul>
    ...
    <li>
        ...
        <ul>
            <li class="exclusive">Russian Infantry units are +1 to their combat factor when Attacking into or Defending in woods or
                towns, unless they are attacking across a creek or bridge.
            </li>

            <li class="exclusive">Prussian Infantry units are +1 to their combat factor when Attacking into or Defending in clear,  unless they are attacking across a creek or bridge.</li>
