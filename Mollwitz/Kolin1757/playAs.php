...
?><head>
    ...
    <style>
        body{
            background:#000;
            background:url("<?=base_url("js/Schlacht_von_Kolin_17_7_1737_Gemalde_Karl_Rochling.jpg")?>") #333 no-repeat;
...
<h2 style="text-align:center;font-size:30px;font-family:'Monsieur La Doulaise'"> Welcome to</h2>
    <h1 style=""><span>Kolin 1757</span></h1>
</div>
...
<fieldset ><Legend>Play As </Legend>
    ...
    <div class="attribution">
        Carl Röchling [Public domain], <a target='blank' href="http://commons.wikimedia.org/wiki/File%3ASchlacht_von_Kolin_17_7_1737_Gem%C3%A4lde_Karl_R%C3%B6chling.jpg">via Wikimedia Commons</a>    </div>
</fieldset>
