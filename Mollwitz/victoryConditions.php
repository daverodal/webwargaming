<div>
    ...
    <ol>
        <li> At the end of any turn that one player has accumulated 35 Victory Points. Victory Points are awarded when
            one player destroys another players unit. 1 <abbr title="Victory Point">VP</abbr> per strength point killed.
            Victory Points are display in the Victory: box at the top of the page.
        </li>

        <li>If at the end of any Austrian player turn there are Prussian units in any hex of Mollwitz. The Prussians win.
        </li>
