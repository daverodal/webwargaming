...
//            $this->gameRules->addPhaseChange(RED_REPLACEMENT_PHASE, RED_MOVE_PHASE, MOVING_MODE, RED_FORCE, BLUE_FORCE, false);
            ...
            $this->terrain->addTerrain(1419 ,3 , "river");
            $this->terrain->addTerrain(1420 ,4 , "river");
            $this->terrain->addTerrain(1420 ,3 , "river");
            $this->terrain->addTerrain(1421 ,4 , "river");
            $this->terrain->addTerrain(1319 ,2 , "road");
            $this->terrain->addTerrain(1320 ,1 , "road");
            $this->terrain->addReinforceZone(1320,'A');
            $this->terrain->addTerrain(1320 ,2 , "road");
            $this->terrain->addTerrain(1321 ,1 , "road");
            $this->terrain->addReinforceZone(1321,'A');
            $this->terrain->addTerrain(1719 ,2 , "road");
            $this->terrain->addTerrain(1720 ,1 , "road");
            $this->terrain->addReinforceZone(1720,'A');
            $this->terrain->addTerrain(1720 ,2 , "road");
            $this->terrain->addTerrain(1721 ,1 , "road");
            $specialHexB[] = 1721;
            $this->terrain->addReinforceZone(1721,'A');
            $specialHexB[] = 2121;
            $this->terrain->addTerrain(2121 ,1 , "road");
            $this->terrain->addReinforceZone(2121,'A');
            $this->terrain->addTerrain(2119 ,2 , "road");
            $this->terrain->addTerrain(2120 ,1 , "road");
            $this->terrain->addReinforceZone(2120,'A');
            $this->terrain->addTerrain(2120 ,2 , "road");
            ...
            $this->terrain->addReinforceZone(1020,'A');
            $this->terrain->addReinforceZone(1021,'A');
            $this->terrain->addReinforceZone(1120,'A');
            $this->terrain->addReinforceZone(1121,'A');
            $this->terrain->addReinforceZone(1220,'A');
            $this->terrain->addReinforceZone(1221,'A');
            $this->terrain->addReinforceZone(1420,'A');
            $this->terrain->addReinforceZone(1421,'A');
            $this->terrain->addReinforceZone(1520,'A');
            $this->terrain->addReinforceZone(1521,'A');
            $this->terrain->addReinforceZone(1620,'A');
            $this->terrain->addReinforceZone(1621,'A');
            $this->terrain->addReinforceZone(1820,'A');
            $this->terrain->addReinforceZone(1821,'A');
            $this->terrain->addReinforceZone(1920,'A');
            $this->terrain->addReinforceZone(1921,'A');
            $this->terrain->addReinforceZone(2020,'A');
            $this->terrain->addReinforceZone(2021,'A');
