<?php
set_include_path(__DIR__ . "/Chillianwallah1849" . PATH_SEPARATOR . get_include_path());
...
class Chillianwallah1849 extends IndiaCore
{
    ...
    static function getHeader($name, $playerData, $arg = false)
    {
        ...
        @include_once "Chillianwallah1849Header.php";
    ...
    public function init()
    {
        ...
        for ($i = 0; $i < 3; $i++) {
            $this->force->addUnit("infantry-1", SIKH_FORCE, "deployBox", "SikhArtBadge.png", 2, 2, 2, true, STATUS_CAN_DEPLOY, "A", 1, 3, "Sikh", false, 'artillery');
        }
        for ($i = 0; $i < 1; $i++) {
    ...
    function __construct($data = null, $arg = false, $scenario = false, $game = false)
    {
        ...
        if ($data) {
            ...
            $this->victory = new Victory("Mollwitz/Chillianwallah1849/chillianwallah1849VictoryCore.php", $data);
