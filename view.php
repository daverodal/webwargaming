...
<div id="leftcol">
    <?php global $results_name;?>
        ...
        <div id="crt">
            <h3>Combat Odds</h3>
            <div id="odds"><span class="col0">&nbsp;</span></span><span class="col1">0</span> <span
                class="col2">1</span> <span class="col3">2</span> <span class="col4">3</span> <span
                class="col5">4</span> <span class="col6">5</span></div>
            <?php
...
<div id="gameImages" >
    ...
    <img class="unit" id="1" alt="0" src="<?php echo base_url();?>js/infantry-3a.png" class="counter" style="position: absolute; left: 180px; top: 140px; z-index:100">
    <img class="unit" id="2" alt="0" src="<?php echo base_url();?>js/infantry-3a.png" class="counter" style="position: absolute; left: 180px; top: 140px; z-index:100">
    <img class="unit" id="3" alt="0" src="<?php echo base_url();?>js/infantry-1a.png" class="counter" style="position: absolute; left: 180px; top: 140px; z-index:100">
    <img class="unit" id="4" alt="0" src="<?php echo base_url();?>js/infantry-1a.png" class="counter" style="position: absolute; left: 180px; top: 140px; z-index:100">
    <img class="unit" id="5" alt="0" src="<?php echo base_url();?>js/armour-1a.png" class="counter" style="position: absolute; left: 180px; top: 140px; z-index:100">
