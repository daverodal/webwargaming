...
class Manchuria1976 extends Battle
{
    ...
    function __construct($data = null, $arg = false, $scenario = false, $game = false)
    {
        ...
        if ($data) {
            ...
            $this->mapData->setData(39, 33, "js/Manchuria1976VladSmall.png");
...
//            );
          ...
          // end unit data -------------------------------------------
            ...
            $specialHexA[] = 1722;
            $this->terrain->addReinforceZone(1722,'A');
            ...
            $this->terrain->addReinforceZone(922,'A');
            $this->terrain->addTerrain(1022 ,1 , "mountain");
            $this->terrain->addReinforceZone(1022,'A');
            $this->terrain->addTerrain(1023 ,1 , "mountain");
            $this->terrain->addReinforceZone(1023,'A');
            $this->terrain->addTerrain(1124 ,1 , "mountain");
            $this->terrain->addReinforceZone(1124,'A');
            $this->terrain->addTerrain(1224 ,1 , "mountain");
            $this->terrain->addReinforceZone(1224,'A');
            $this->terrain->addTerrain(1325 ,1 , "mountain");
            $this->terrain->addReinforceZone(1325,'A');
            $this->terrain->addTerrain(1324 ,1 , "mountain");
            $this->terrain->addReinforceZone(1324,'A');
            $this->terrain->addTerrain(1223 ,1 , "mountain");
            $this->terrain->addReinforceZone(1223,'A');
            $this->terrain->addTerrain(1123 ,1 , "mountain");
            $this->terrain->addReinforceZone(1123,'A');
            $this->terrain->addTerrain(1122 ,1 , "mountain");
            $this->terrain->addReinforceZone(1122,'A');
            $this->terrain->addTerrain(1222 ,1 , "mountain");
            $this->terrain->addReinforceZone(1222,'A');
            ...
            $this->terrain->addReinforceZone(2230,'B');
            ...
            $this->terrain->addReinforceZone(1822,'A');
            $this->terrain->addTerrain(1922 ,3 , "road");
            $this->terrain->addTerrain(1922 ,1 , "road");
            $this->terrain->addReinforceZone(1922,'A');
            ...
            $this->terrain->addReinforceZone(1728,'A');
            $this->terrain->addReinforceZone(1727,'A');
            $this->terrain->addReinforceZone(1726,'A');
            $this->terrain->addReinforceZone(1725,'A');
            $this->terrain->addReinforceZone(1723,'A');
            $this->terrain->addReinforceZone(1724,'A');
            $this->terrain->addReinforceZone(1823,'A');
            $this->terrain->addReinforceZone(1824,'A');
            $this->terrain->addReinforceZone(1825,'A');
            $this->terrain->addReinforceZone(1924,'A');
            $this->terrain->addReinforceZone(1923,'A');
            ...
            $this->terrain->addReinforceZone(2112,'A');
            ...
            $this->terrain->addTerrain(115 ,1 , "blocked");
            $this->terrain->addTerrain(214 ,1 , "blocked");
            $this->terrain->addTerrain(213 ,1 , "blocked");
            $this->terrain->addTerrain(212 ,1 , "blocked");
            $this->terrain->addTerrain(313 ,1 , "blocked");
            $this->terrain->addTerrain(314 ,1 , "blocked");
            $this->terrain->addTerrain(414 ,1 , "blocked");
            $this->terrain->addTerrain(515 ,1 , "blocked");
            $this->terrain->addTerrain(615 ,1 , "blocked");
            $this->terrain->addTerrain(716 ,1 , "blocked");
            $this->terrain->addTerrain(816 ,1 , "blocked");
            $this->terrain->addTerrain(817 ,1 , "blocked");
            $this->terrain->addTerrain(717 ,1 , "blocked");
            $this->terrain->addTerrain(617 ,1 , "blocked");
            $this->terrain->addTerrain(517 ,1 , "blocked");
            $this->terrain->addTerrain(416 ,1 , "blocked");
            $this->terrain->addTerrain(317 ,1 , "blocked");
            $this->terrain->addTerrain(318 ,1 , "blocked");
            $this->terrain->addTerrain(418 ,1 , "blocked");
            $this->terrain->addTerrain(419 ,1 , "blocked");
            $this->terrain->addTerrain(520 ,1 , "blocked");
            $this->terrain->addTerrain(620 ,1 , "blocked");
            $this->terrain->addTerrain(621 ,1 , "blocked");
            $this->terrain->addTerrain(722 ,1 , "blocked");
            $this->terrain->addTerrain(1631 ,1 , "blocked");
            $this->terrain->addTerrain(1732 ,1 , "blocked");
            $this->terrain->addTerrain(1832 ,1 , "blocked");
            $this->terrain->addTerrain(1733 ,1 , "blocked");
            $specialHexB[] = 1932;
            $this->terrain->addReinforceZone(1932,'B');
            $this->terrain->addReinforceZone(1831,'B');
            $this->terrain->addReinforceZone(1931,'B');
            ...
            $this->terrain->addReinforceZone(1626,'A');
            $this->terrain->addReinforceZone(1625,'A');
            $this->terrain->addReinforceZone(1624,'A');
            $this->terrain->addReinforceZone(1623,'A');
            $this->terrain->addReinforceZone(1622,'A');
            ...
            $this->terrain->addReinforceZone(1527,'A');
            $this->terrain->addReinforceZone(1526,'A');
            $this->terrain->addReinforceZone(1525,'A');
            $this->terrain->addReinforceZone(1524,'A');
            $this->terrain->addReinforceZone(1523,'A');
            $this->terrain->addReinforceZone(1522,'A');
            $this->terrain->addReinforceZone(1421,'A');
            $this->terrain->addReinforceZone(1422,'A');
            $this->terrain->addReinforceZone(1423,'A');
            $this->terrain->addReinforceZone(1424,'A');
            $this->terrain->addReinforceZone(1425,'A');
            $this->terrain->addReinforceZone(1426,'A');
            $this->terrain->addReinforceZone(1326,'A');
            $this->terrain->addReinforceZone(1327,'A');
            ...
            $this->terrain->addReinforceZone(1322,'A');
            $this->terrain->addReinforceZone(1323,'A');
