...
<div class="dropDown" id="GRWrapper">
    ...
    <div id="GR" style="display:none">
        ...
        <div id="gameRules">
            ...
            <p></p>
            If a units numbers are in white, that means this unit is at reduced strength and can receive replacements
            ...
            <ul>
                <li>
                    ...
                    <ol>
                        <li>
                            ...
                            The phasing player may allocate as many replacements as they received. <?= $playerOne ?>
                        ...
                        <li>
                            ...
                            The phasing player may move any or all of their <strong>Armored</strong> or <strong>mechinized
                                infantry</strong> units. Infantry units may <strong>not</strong> move in the second
                            movement phase.
                        </li>
                    </ol>
                </li>
                <li>
                    ...
                    <ol>
                        <li>
                            <h4>Replacement Phase</h4>
                            The phasing player may receive as many replacements as they are allocated. <?= $playerTwo ?>
            ...
            <h4>Units expend different amounts of <abbr title="Movement Points">MP</abbr> for different terrains. Also,
                different units may expend
                different amounts to enter certain hexes.</h4>
            <ul>
                <li>The number of movement points or <abbr title="Movement Points">MP</abbr>'s a unit expends to enter a
                    hex is baseed
            ...
            <ul>
                <li><p>
                    ...
                    <p>When a unit enters a hostile <abbr title="Zone Of Control">ZOC</abbr> it must either stop and
                        ...
                        certain amounts of <abbr title="Zone Of Control">MP's</abbr>to enter the hex, depending upon the
                        unit. If a units starts the
                        turn in a <abbr title="Zone Of Control">ZOC</abbr>, it may require movement points to leave the
                    ...
                    <ul>
                        <li>Mechanized units<p>A mechanized unit (units with a second movement phase) require 2
                            ...
                            <p>Mechanized units may move directly from one <abbr title="Zone Of Control">ZOC</abbr> to
                                another
                        ...
                        <li>Infantry units
                            <p>Infantry units must stop upon entering a <abbr title="Zone Of Control">ZOC</abbr>.
                                ...
                                provided they do not move directly from one <abbr title="Zone Of Control">ZOC</abbr> to
                                another.</p>

                            <?php if ($name == "Manchuria1976") { ?>
                                <p class="exclusive"><?= $playerTwo ?> Infantry that start their turn in a mountain hex
                                    in an enemy <abbr title="Zone Of Control">ZOC</abbr>, may move directly to another
                                    hexagon with an enemy <abbr title="Zone Of Control">ZOC</abbr>,at which point they
